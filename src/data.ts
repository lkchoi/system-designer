...
export const COMPONENTS: ComponentDefinition[] = [
  ...
  { type: 'search-engine', label: 'Search Engine', color: '#d97706', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
  { type: 'dns', label: 'DNS', color: '#0ea5e9', icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z' },
  { type: 'serverless', label: 'Serverless', color: '#f472b6', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { type: 'container-orchestration', label: 'Containers', color: '#0891b2', icon: 'M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z' },
  { type: 'stream-processor', label: 'Stream Processor', color: '#10b981', icon: 'M4 4h16v4H4zm0 6h16v4H4zm0 6h16v4H4z' },
  { type: 'data-warehouse', label: 'Data Warehouse', color: '#7c3aed', icon: 'M4 7v10c0 2.2 3.6 4 8 4s8-1.8 8-4V7M4 7c0-2.2 3.6-4 8-4s8 1.8 8 4M4 7c0 2.2 3.6 4 8 4s8-1.8 8-4M4 12c0 2.2 3.6 4 8 4s8-1.8 8-4' },
];
