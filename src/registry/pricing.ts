 ...
 *
 * Auto-generated by scripts/pricing/run.ts on 2026-04-14.
...
export const PRICING: Record<string, TechnologyPricing> = {
  ...
  "Amazon Aurora": {
    ...
    tiers: [
      ...
      },
      {
        ...
        price: "$0.10/GB-month",
        description: "Aurora Standard mode",
      },
      {
  ...
  DynamoDB: {
    ...
    tiers: [
      ...
      {
        name: "Standard Storage",
        price: "$0.2500/GB-month",
        description: "First 25 GB free",
      },
      {
  ...
  "Google Cloud Firestore": {
    ...
    tiers: [
      ...
      {
        name: "Deletes",
        price: "$0.02 per 100,000",
        description: "$0.20/million deletes",
      },
      {
        name: "Storage",
        price: "$0.18/GB-month",
        description: "Document and index storage",
      },
  ...
  InfluxDB: {
    ...
    tiers: [
      {
        name: "Data In",
        price: "$0.0025/MB written",
        description: "Write ingestion cost",
      },
      {
        name: "Queries",
        price: "$0.012 per 100 queries",
        description: "Query execution cost",
      },
  ...
  MariaDB: {
    ...
    tiers: [
      ...
      { name: "RDS db.m5.large", price: "$0.1710/hr", description: "2 vCPU, 8 GB RAM" },
      {
        name: "SkySQL",
        price: "~$0.45–$10.14/hr",
    ...
    tiers: [
      {
        name: "M0 (Free)",
        price: "$0/month",
        description: "512 MB storage, shared CPU/RAM",
      },
      {
        name: "Flex",
  ...
  MySQL: {
    ...
    tiers: [
      ...
      { name: "db.m7g.large", price: "$0.1680/hr", description: "2 vCPU, 8 GB RAM" },
      {
        name: "gp3 Storage",
    ...
    tiers: [
      {
        name: "db.t4g.micro",
        price: "$0.0160/hr",
        description: "2 vCPU, 1 GB RAM — dev/test",
      },
      { name: "db.t4g.medium", price: "$0.0650/hr", description: "2 vCPU, 4 GB RAM" },
      {
        name: "db.m7g.large",
    ...
    tiers: [
      {
        ...
        description: "8x5 support, 99.9% SLA",
      },
      {
  ...
  "SQL Server": {
    ...
    tiers: [
      ...
      {
        name: "Standard S0 (10 DTU)",
        price: "$0.1700/1 GB/Month",
        description: "Light production",
      },
      {
        name: "Standard S2 (50 DTU)",
        price: "$0.1700/1 GB/Month",
        description: "Medium workloads",
      },
      {
        name: "Premium P1 (125 DTU)",
        price: "$0.3400/1 GB/Month",
  ...
  SQLite: {
    ...
    tiers: [
      ...
      },
      {
        name: "Turso Scaler",
        price: "$24.92/month",
        description: "100B reads; 24 GB storage",
      },
      {
  ...
  TiDB: {
    ...
    tiers: [
      ...
      {
        name: "Starter Columnar Storage",
        price: "$0.05/GiB-month",
        description: "TiFlash",
      },
      {
  ...
  "Azure API Management": {
    ...
    tiers: [
      ...
      { name: "Developer", price: "~$50/month", description: "Dev/test only, no SLA" },
      {
        name: "Basic v2",
        price: "$0.2055/1 Hour",
        description: "Includes VNet integration",
      },
      {
        name: "Standard v2",
        price: "$0.6849/1 Hour",
        description: "4x cheaper than old Premium",
      },
      {
  ...
  "Cloudflare API Gateway": {
    ...
    tiers: [
      ...
      { name: "Pro", price: "$20/month", description: "250 endpoints + 20 WAF rules" },
      {
        name: "Business",
        price: "$200/month",
        description: "500 endpoints + advanced WAF",
      },
      {
  ...
  "AWS NLB": {
    ...
    tiers: [
      { name: "Hourly Rate", price: "$0.0252/hr", description: "~$18.14/month baseline" },
      {
        name: "NLCU",
        price: "$0.006/NLCU-hr",
        description: "TCP/UDP/TLS Layer 4 capacity",
      },
    ],
  },
  "Azure Load Balancer": {
    ...
    tiers: [
      {
        name: "Cloudflare",
        price: "$0 (unlimited)",
        description: "Flat plan, no per-GB charge",
      },
      { name: "CloudFront", price: "$0.085/GB (US/EU)", description: "Pay per GB" },
      {
        name: "Fastly",
        price: "$0.12/GB (US/EU)",
        description: "Pay per GB + per request",
      },
    ],
  },
  "Cloudflare CDN": {
    ...
    tiers: [
      {
        name: "Standard",
        price: "$0.10/GB/hr",
        description: "10 GB = $1/hr = ~$720/month",
      },
      {
        name: "Dedicated",
        price: "Custom",
        description: "Contact sales for private pricing",
      },
    ],
    ...
    tiers: [
      {
        name: "Open Source",
        price: "Free",
        description: "Multi-threaded Redis fork, self-hosted",
      },
    ],
  },
  Memcached: {
  ...
  "Apache Kafka": {
    ...
    tiers: [
      ...
      },
      {
        name: "Networking",
        price: "$0.014–$0.05/GB",
        description: "Data in/out, varies by tier",
      },
  ...
  "Apache Pulsar": {
    ...
    tiers: [
      ...
      },
      {
        name: "BYOC",
        price: "~$365/month",
        description: "Your VPC, managed by StreamNative",
      },
      {
        name: "Dedicated",
        price: "~$505/month",
        description: "Fully isolated, enterprise SLAs",
      },
    ],
    modes: [
      {
  ...
  RabbitMQ: {
    ...
    tiers: [
      {
        name: "mq.t3.micro (single)",
        price: "$0.034/hr",
        description: "2 vCPU, 1 GB — dev only",
      },
      ...
      },
      {
        name: "EBS Storage",
        price: "$0.10/GB-month",
        description: "Default 200 GB per node",
      },
    ],
    modes: [
      {
  ...
  "Redis Streams": {
    ...
    tiers: [
      { name: "Free", price: "$0/month", description: "500K commands/month, 256 MB" },
      {
        name: "Pay-as-you-go",
        price: "$0.20/100K commands",
        description: "Up to 100 GB storage",
      },
      {
        name: "Fixed (smallest)",
        price: "$10/month",
  ...
  "Amazon S3": {
    ...
    tiers: [
      ...
      },
      {
        name: "One Zone-IA",
        price: "$0.01/GB-month",
        description: "Single AZ, 20% cheaper",
      },
      {
  ...
  "Azure Blob Storage": {
    ...
    tiers: [
      ...
      { name: "Cool", price: "$0.0100/10K", description: "30-day min" },
      {
        name: "Cold",
        price: "$0.004/GB-month",
        description: "90-day min, $0.03/GB retrieval",
      },
      {
        name: "Archive",
        price: "$0.2100/10K",
  ...
  "Google Cloud Storage": {
    ...
    tiers: [
      ...
      },
      {
        name: "Coldline",
        price: "$0.004/GB-month",
        description: "90-day min, $0.02/GB retrieval",
      },
      {
        name: "Archive",
  ...
  "AWS WAF": {
    ...
    tiers: [
      ...
      {
        name: "Rules",
        price: "$1.00/month each",
        description: "Per custom rule or rule group",
      },
    ...
    tiers: [
      {
        name: "Free",
        price: "$0/month",
        description: "Basic DDoS only, no custom WAF rules",
      },
      {
        name: "Pro",
        price: "$20/month",
        description: "Managed Ruleset + 20 custom rules",
      },
    ...
    tiers: [
      {
        name: "Open Source",
        price: "Free",
        description: "Plugin-based DNS server, K8s built-in",
      },
    ],
  },
  "GCP Cloud DNS": {
  ...
  "Azure Functions": {
    ...
    tiers: [
      ...
      },
      {
        ...
        price: "$0.00001600/1 GB Second",
        description: "Configurable memory (512 MB–4 GB)",
      },
      {
        name: "Premium EP1",
        price: "$0.0123/1 GiB Hour",
        description: "1 vCPU, 3.5 GB — always-on, no cold starts",
      },
      { name: "Premium EP2", price: "$0.0123/1 GiB Hour", description: "2 vCPU, 7 GB" },
    ],
    ...
    tiers: [
      {
        name: "Free Plan",
        price: "$0/month",
        description: "100K requests/day, 10ms CPU/request",
      },
      {
        name: "Paid Plan Base",
        price: "$5/month",
      ...
      {
        name: "CPU Overage",
        price: "$0.02/million CPU-ms",
        description: "Above 30M CPU-ms",
      },
    ],
  ...
  "Google Cloud Functions": {
    ...
    tiers: [
      ...
      {
        name: "Memory (GB-second, Tier 1)",
        price: "$0.0000025",
        description: "Standard regions",
      },
      {
        name: "CPU (GHz-second, Tier 1)",
        price: "$0.0000100",
        description: "Standard regions",
      },
  ...
  "Google Cloud Run": {
    ...
    tiers: [
      {
        name: "CPU (Tier 1)",
        price: "$0.000024/vCPU-sec",
        description: "Standard regions",
      },
      {
        name: "Memory (Tier 1)",
        price: "$0.0000025/GiB-sec",
        description: "Standard regions",
      },
  ...
  "Kubernetes (K8s)": {
    ...
    tiers: [
      ...
      {
        name: "EC2 m7g.large (ARM)",
        price: "~$0.077/hr",
        description: "~20% cheaper, Graviton3",
      },
      {
      ...
      {
        name: "GKE Autopilot (Memory)",
        price: "$0.0049/GiB-hr",
        description: "Per-pod billing",
      },
    ],
    modes: [
      {
    ...
    tiers: [
      {
        name: "KPU Compute",
        price: "$0.11/KPU-hr",
        description: "1 vCPU + 4 GB RAM per KPU",
      },
      {
    ...
    tiers: [
      {
        ...
        price: "Free",
        description: "Runs in your JVM application",
      },
      {
  ...
  "Google Dataflow": {
    ...
    tiers: [
      ...
      },
      {
        name: "Streaming vCPU",
        price: "$0.072/vCPU-hr",
        description: "~22% premium over batch",
      },
      {
        name: "Memory",
        price: "$0.004172/GB-hr",
        description: "Same for batch and streaming",
      },
      {
  ...
  RisingWave: {
    ...
    tiers: [
      ...
      {
        name: "Storage",
        price: "$0.0299/GB-month",
        description: "Materialized view storage",
      },
  ...
  "Apache Druid": {
    ...
    tiers: [
      ...
      {
        name: "Ingestion (first 1 TB)",
        price: "$0.35/GB",
        description: "Decreases with volume",
      },
      {
        name: "Ingestion (>10 TB)",
        price: "$0.15/GB",
        description: "Bulk volume discount",
      },
      {
        name: "Deep Storage",
        price: "$0.06–$0.08/GB-month",
  ...
  ClickHouse: {
    ...
    tiers: [
      ...
      {
        name: "Storage",
        price: "$25.30/TiB-month",
        description: "Compressed data, AWS us-east-1",
      },
    ],
  ...
  "Databricks (Lakehouse)": {
    ...
    tiers: [
      ...
      },
      {
        name: "Jobs Compute",
        price: "~$0.15/DBU-hr",
        description: "Standard batch/ETL pipelines",
      },
      {
      ...
      },
      {
        name: "SQL Classic",
        price: "~$0.22/DBU-hr",
        description: "BI dashboards, SQL queries",
      },
      {
        name: "SQL Serverless",
        price: "~$0.70/DBU-hr",
  ...
  "Google BigQuery": {
    ...
    tiers: [
      ...
      },
      {
        name: "Standard Slots",
        price: "$0.04/slot-hr",
        description: "PAYG, basic autoscaling",
      },
      {
  ...
  Snowflake: {
    ...
    tiers: [
      ...
      {
        name: "Storage (on-demand)",
        price: "~$40/TB-month",
        description: "US AWS regions",
      },
      {
  ...
  "Azure Logic Apps": {
    ...
    tiers: [
      ...
      {
        name: "Standard Plan WS3",
        price: "$0.0143/1 GiB Hour",
        description: "4 vCPU, 14 GB",
      },
    ],
    ...
    tiers: [
      {
        name: "Build (Free)",
        price: "$0/month",
        description: "10K requests + 1M records",
      },
      {
        name: "Grow Requests",
    ...
    tiers: [
      {
        name: "Open Source",
        price: "Free",
        description: "Apache License 2.0, Lucene-based",
      },
      {
  ...
  Meilisearch: {
    ...
    tiers: [
      ...
      {
        name: "XS (Resource-based)",
        price: "$20.44/month",
        description: "0.5 vCPU, 1 GB RAM",
      },
      {
        name: "M (Resource-based)",
        price: "$81.03/month",
        description: "2 vCPU, 4 GB RAM",
      },
      {
        name: "XL (Resource-based)",
        price: "$353.32/month",
  ...
  OpenSearch: {
    ...
    tiers: [
      { name: "t3.small.search", price: "$0.0360/hr", description: "2 GB RAM — dev/test" },
      {
        ...
        price: "$0.1670/hr",
        description: "16 GB RAM — production",
      },
      {
        name: "Serverless OCU",
        price: "$0.24/OCU-hr",
    ...
    tiers: [
      {
        name: "Library",
        price: "Free",
        description: "MIT license, client-side framework",
      },
    ],
  },
  "React Native": {
    ...
    tiers: [
      {
        ...
        price: "Free",
        description: "MIT/Apache 2.0 licenses",
      },
    ],
  },
    ...
    tiers: [
      {
        name: "Custom Events",
        price: "$1.00/million",
        description: "Ingestion + delivery",
      },
      {
