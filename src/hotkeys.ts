...
export const HOTKEYS: HotkeyDef[] = [
  ...
  { id: 'clear-canvas', key: 'k', mod: true,  shift: true, label: 'Clear canvas', category: 'Canvas' },
  { id: 'select-all',   key: 'a', mod: true,  guard: true, label: 'Select all nodes', category: 'Canvas' },

  // Flow path
  { id: 'toggle-path', key: 'f',            guard: true, label: 'Toggle flow path',  category: 'Flow Path' },
  { id: 'save-path',   key: 's', shift: true, guard: true, label: 'Save flow path',   category: 'Flow Path' },
  { id: 'clear-path',  key: 'x', shift: true, guard: true, label: 'Clear flow path',  category: 'Flow Path' },
